# Задание 5
В этом файле представлено краткое описание последовательности действий и технической стороны вопроса. [Полная версия отчета доступна по ссылке](https://docs.google.com/document/d/1UDxH9TR0qAIyupG5nlVWy0xb0LyxQZNxn3XYAQFKyPs/edit?usp=sharing). 
...
| 4 | rs121909343 | DCTN1 | 2 | 44089581 | Синдром Перри, ALS | 0/1 (A/G) | 0/0 (A/A) | G-A |
...
| 6 | rs4402960 | IGF2BP2 | Сахарный диабет 2 типа | 0/1 | 0/0 | G-A |
