...
- Референсный штамм чувствителен к: [ЗДЕСЬ ДОБАВИТЬ ДАННЫЕ]
...
- Найденные гены: [ЗДЕСЬ ДОБАВИТЬ НАЗВАНИЯ ГЕНОВ И ИХ ЛОКАЛИЗАЦИЮ]

Анализируем соседние гены, чтобы определить механизм приобретения:
- [ЗДЕСЬ ДОБАВИТЬ ДАННЫЕ, например: «Ген β-лактамазы окружён транспозонными последовательностями, что свидетельствует о горизонтальном переносе через мобильные элементы»]
