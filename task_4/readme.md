...
## Шаг 5
Для поиска гомологичных белков в базах данных воспользовались веб версией blast, анализировали файл candidates.fa, [вот что получилось](https://blast.ncbi.nlm.nih.gov/Blast.cgi?CMD=Get&RID=Y7BHKMDP014).

## Шаг 6
В веб версии Pfam HMMER произведен поиск доменов, предсказание функции пептидов, [результаты доступны по ссылке](https://www.ebi.ac.uk/Tools/hmmer/results/6b3aee6c-a34e-4412-b1ee-c2156375e7f4/score).
_p.s. локально, если сайт не грузится: [вот тут](task_4/step_6/pfam_results.txt)_
