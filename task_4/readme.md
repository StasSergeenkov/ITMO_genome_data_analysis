# Задание 4
В этом файле представлено краткое описание последовательности действий и технической стороны вопроса. [Полная версия отчета доступна по ссылке](https://docs.google.com/document/d/10wlNrMarffPRziaFyad3I1Flz4DMXzNlFcErbXyOXIw/edit?usp=sharing). 
...
```
Файл с последовательностями белков [доступен по ссылке](task_4/step_3/candidates.fa)

## Шаг 4
Для предсказания субклеточной локализации белков на основе их аминокислотной последовательности воспользовались WoLF PSORT, [вот результат](task_4/step_4/wolf_psort.txt)  
Для уточнения локализации воспользовались TargetP Server: он предсказывает наличие сигнальных пептидов, митохондриальных или хлоропластных транзитных пептидов, [вот результат](task_4/step_4/targetp_results.txt)

## Шаг 5
Для поиска гомологичных белков в базах данных воспользовались веб версией blast, анализировали файл candidates.fa, [вот что получилось](task_4/step_5/Y7BHKMDP014.txt).

## Шаг 6
В веб версии Pfam HMMER произведен поиск доменов, предсказание функции пептидов, [результаты доступны по ссылке](task_4/step_6/pfam_results.txt).
