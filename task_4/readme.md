...
## Шаг 5
Для поиска гомологичных белков в базах данных воспользовались веб версией blast, анализировали файл candidates.fa, [вот что получилось](https://blast.ncbi.nlm.nih.gov/Blast.cgi?CMD=Get&RID=Y7BHKMDP014). Файл с результатами доступен [вот тут]().
